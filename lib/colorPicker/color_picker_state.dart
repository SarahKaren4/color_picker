...
class ColorPickerLoaded extends ColorPickerState {
  ...
  ColorPickerLoaded(
      {this.listeCouleur = const [
        ColorPicker(couleur: Color.fromARGB(255, 249, 3, 85), statutcouleur: true),
        ColorPicker(couleur: Color.fromARGB(255, 208, 75, 168), statutcouleur: true),
        ColorPicker(couleur: Color.fromARGB(255, 175, 52, 171), statutcouleur: true),
        ColorPicker(couleur: Color.fromARGB(255, 237, 214, 41), statutcouleur: true),
      ...
      this.indexTop = const [-1, -1, -1]});  @override
